...
The similarity values are stored as plain text. Only the upper triangle of
the symmetric similarity matrix is saved.

=item I<"libsvm">

The similarity values are stored as precomputed kernel for libsvm. The full
similarity matrix is stored.
