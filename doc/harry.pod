...
Jaro-Winkler distance, Lee distance, normalized compression distance and
bag distance.
...
The following similarity coefficients for strings are supports: Simpson
coefficient, Jaccard coefficient, Braun-Blanquet coefficient, Czekanowski
coefficient (Soerensen-Dice coefficient), Kulczynski coefficient (1st),
Kulczynski coefficient (2nd), Sokal-Sneath coefficient (Anderberg
coefficient), Otsuka coefficent (Ochiai coefficient).
