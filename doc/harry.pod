...
If this parameter is to I<true>, the indices of the strings will be stored
in an extra column and row in some output formats.

=item B<save_labels = false;>

If this parameter is to I<true>, the labels of the strings will be stored in
an extra column and row in some output formats.

=item B<save_sources = false;>

If this parameter is to I<true>, the sources of the strings will be stored
in an extra column and row in some output formats.

=item B<upper_triangle = false;>

If this parameter is set to I<true> only the upper triangle of the
similarity matrix will be stored in most output formats.
