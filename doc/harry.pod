...
Harry is currently under development. The following distance and
kernel functions for strings are supported so far

=over 36

=item Hamming distance

see measure B<dist_hamming>

=item Levenshtein distance

see measure B<dist_levenshtein>

=item Damerau-Levenshtein distance

see measure B<dist_damerau>

=item Jaro distance

see measure B<dist_jarowinkler>
...
see measure B<dist_lee>

=item Compression distance

see measure B<dist_compression>

=item Weighted-degree kernel

see measure B<kern_wdegree>

=item Weighted-degree kernel with shifts

see measure B<kern_wdegree>

=item Subsequence kernel

see measure B<kern_subsequence>
...
This module implements the compression distance for strings (XXX). The
compression is implemented using B<zlib>.  The runtime complexity of a
