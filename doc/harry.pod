...
=item B<distance = "levenshtein";>

This parameter selects the distance to use for the kernel. Depending on the
type of the substitution and the selected distance, the kernel might not be
