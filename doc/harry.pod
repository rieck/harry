...
=item I<"sim_braunblanquet">

=item I<"sim_czekanowski">

=item I<"sim_sokalsneath">
...
Similartiy coefficients: Simpson, Jaccard Braun-Blanquet, Czekanowski (also
known as Soerensen-Dice), Sokal-Sneath (also known as Anderberg) Kulczynski
1, Kulczynski 2, Otsuka (also known as Ochiai). See configuration section
B<sim_coefficient>.
